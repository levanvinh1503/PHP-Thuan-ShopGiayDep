  ...
  <div class="header-top">
   ...
   <div class="header-bottom">
       ...
       <h4 class="title"> Danh sách các nhân viên</h4>
       				...
       				<?php
       					...
       					if ($results) { 
					        while($obj = $results->fetch_object())
					        {
					        	...
					        	echo '<tr>';
					        		echo '<td>'.$obj->MaNv.'</td>';
					        		echo '<td>'.$obj->TenNv.'</td>';
					        		echo '<td>'.$obj->GioiTinh.'</td>';
					        		echo '<td>'.$obj->NgaySinh.'</td>';
					        		echo '<td>'.$obj->DiaChi.'</td>';
					        		echo '<td>'.$obj->Sdt.'</td>';
					        		echo '<td><a href="qlnhanvien_chushop_Xoa.php?manhanvien='.$obj->MaNv.'">xóa</a></td>';
					        		echo '<td><a href="qlnhanvien_chushop_Sua.php?manhanvien='.$obj->MaNv.'&tennhanvien='.$obj->TenNv.'&gioitinh='.$obj->GioiTinh.'&ngaysinh='.$obj->NgaySinh.'&diachi='.$obj->DiaChi.'&sodienthoai='.$obj->Sdt.'">Sửa</a></td>';
					        	echo '</tr>';
       		...
       		<a href="qlnhanvien_chushop_Them.php"><button class="btn btn-info">Thêm nhân viên</button></a>
       		</div>
       		</div>
	    <div class="footer">
