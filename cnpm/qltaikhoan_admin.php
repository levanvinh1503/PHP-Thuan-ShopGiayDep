   	...
   	<div class="wrap">
		...
		<ul class="megamenu skyblue">
     	...
     	<div class="register_account">
          	<div class="wrap">
          	<h2 class="title">Danh sách các tài khoản</h2>
          		<form class="form">
          			<table class="table">
		     			<tr>
		     				<th>UserName</th>
		     			...
		     			<?php
							...
							$results = $mysqli->query("SELECT * FROM tkkhach inner join role on tkkhach.RoleID=role.RoleID");
			          		if ($results) { 
								while($obj = $results->fetch_object())
								{
					     			echo '<tr>';
					     				...
					     				echo '<td><a href="qltaikhoan_admin_sua.php?username='.$obj->Username.'&password='.$obj->Pass.'">Sửa</a> | <a href="qltaikhoan_admin_xoa.php?username='.$obj->Username.'">Xóa</a></td>';
					     			echo '</tr>';
					     		}
					     	}
					     ?>
